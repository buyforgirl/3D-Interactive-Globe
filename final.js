...
window.onload = function init() {
    ...
    program[0] = initShaders( gl, "vs", "fs" );
    ...
    //for skybox
    program[1] = initShaders( gl, "skyboxvs", "skyboxfs" );
...
initTexture(dayTex, "earthmap.png");
initTexture(bumpTex, "earthbump.png");
initTexture(cloudTex, "earthcloud.png");
initTexture(transTex, "earthtrans.png");
initTexture(lightTex, "earthlight.png");
initTexture(specTex, "earthspec.png");
...
skyboxfaces[0] = [gl.TEXTURE_CUBE_MAP_POSITIVE_X, "skybox_ft.jpg"];
skyboxfaces[1] = [gl.TEXTURE_CUBE_MAP_NEGATIVE_X, "skybox_bk.jpg"];
skyboxfaces[2] = [gl.TEXTURE_CUBE_MAP_POSITIVE_Y, "skybox_up.jpg"];
skyboxfaces[3] = [gl.TEXTURE_CUBE_MAP_NEGATIVE_Y, "skybox_dn.jpg"];
skyboxfaces[4] = [gl.TEXTURE_CUBE_MAP_POSITIVE_Z, "skybox_dn.jpg"];
skyboxfaces[5] = [gl.TEXTURE_CUBE_MAP_NEGATIVE_Z, "skybox_dn.jpg"];
